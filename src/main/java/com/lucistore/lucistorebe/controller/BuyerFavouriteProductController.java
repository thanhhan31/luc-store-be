...
public class BuyerFavouriteProductController {
	...
	public ResponseEntity<?> delete(@PathVariable Long idProduct, @AuthenticationPrincipal UserDetailsImpl<Buyer> buyer) {
		return ResponseEntity.ok(buyerFavouriteProductService.delete(idProduct, buyer.getUser().getId()));
	}
}
